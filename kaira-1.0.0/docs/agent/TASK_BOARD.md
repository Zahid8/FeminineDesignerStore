...
| T3 | Done | Add database models and migrations | `store/models.py`, `store/migrations/`, model tests | `python manage.py test store.tests.test_models store.tests.test_discounts` |
| T4 | Ready | Configure Django admin | `store/admin.py`, `store/tests/test_admin.py` | `python manage.py test store.tests.test_admin` |

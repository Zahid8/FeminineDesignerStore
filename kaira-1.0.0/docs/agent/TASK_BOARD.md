...
| T1 | Ready | Scaffold Django project | `requirements.txt`, `manage.py`, `femdes_site/`, `store/` | `python manage.py check` |
| T2 | Blocked | Move assets into Django static tree | `static/store/`, moved `css/`, `js/`, `images/`, `style.css` | `python manage.py collectstatic --noinput` |
